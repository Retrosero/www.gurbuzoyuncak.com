-- Migration: create_search_and_filtering_system
-- Created at: 1761981074
...
CREATE INDEX IF NOT idx_recently_viewed_user_id ON recently_viewed_products(user_id);
CREATE INDEX IF NOT idx_recently_viewed_product_id ON recently_viewed_products(product_id);
CREATE INDEX IF NOT idx_recently_viewed_viewed_at ON recently_viewed_products(viewed_at DESC);
